...
function TestView:test_render_page_uses_dracula_status_rows_and_non_editable_rule_lists()
  ...
  lu.assertStrContains(html, "Wired filtering only")
  lu.assertStrContains(html, "Blocks matching domains for wired LAN clients whenever internet is available; Wi-Fi clients are unrestricted.")
