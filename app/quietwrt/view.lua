...
<p class="field-help">Adds domains from a previously downloaded ZIP while keeping current entries. Schedule timings in the ZIP are ignored; current timings and enable states are preserved. Restore schedule timings using the SSH CLI.</p>
<form method="post" action="]],
    util.html_escape(script_name),
